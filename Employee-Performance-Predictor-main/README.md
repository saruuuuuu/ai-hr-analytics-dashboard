...
1. Open `⚙️ Train / Setup` in the sidebar
2. Click **Generate Dataset** → creates 1000 synthetic employee records
3. Click **Train Model** → trains RandomForest with GridSearch (~1-2 min)
4. Navigate to any page to explore predictions, EDA, and recommendations
...
Built as a data science portfolio project demonstrating full-stack ML skills:
data engineering → EDA → ML → explainability → deployment.
